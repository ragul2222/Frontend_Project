...
function RegistrationPage() {
  ...
  return (
    ...
    <div className="login-container">
      ...
      <div className="input-container">
        <input type="date" placeholder="DOB" value={dob} onChange={(e) => setBirthDate(e.target.value)} />
      </div>
      <button className="login-button" onClick={handleRegistration}>Signup</button>
